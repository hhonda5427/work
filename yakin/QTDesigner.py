...
# ダブルクリックイベント-編集用
# class candidate_(QtWidgets.QDialog):
#     def __init__(self, src, parent=None):
#         super(candidate, self).__init__(parent)
#         self.rk = src.rk
#         self.dfskill = src.dfskill
#         self.DFrenzoku = src.DFrenzoku
#         self.DFkinmuhyou = src.DFkinmuhyou
#         self.DFkinmuhyou_long = src.DFkinmuhyou
#         self.dfstaff = src.dfstaff
#         self.DFNrdeptcore = src.DFNrdeptcore
#         self.RawDFNrdeptcore = src.RawDFNrdeptcore
